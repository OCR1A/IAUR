...
ofxr, ofyr, thetar = frameOriginCoordinates(64, -269, 565, 416, 41.97)
print(thetar)
x, y = transformCoordinates(50, 50, ofxr, ofyr, thetar)
print(f"ofx: {ofxr}")
print(f"ofy: {ofyr}")
print(f"Transformada x: {x}")
print(f"Transformada y: {y}")
